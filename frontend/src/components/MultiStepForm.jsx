...
const MultiStepForm = () => {
  ...
  const pricingTable = [
    {
      ...
      subjects: "Choose any one (Physics, Chemistry, Biology, English)",
      lessonsPerWeek: 1,
      launchPrice: 20,
      masteryPrice: 5,
    },
  ...
  const handleContinue = () => {
    ...
    if (currentStep === 2 && !isProPlan && !selectedCombination) {
      setShowError(true);
      return;
    }
    if (
          ...
          <div className="flex flex-col items-center space-y-6 p-4 md:p-8">
            ...
            <div className="flex justify-center items-center mb-6">
              <div className="flex items-center space-x-4">
                <span
                  className={`text-sm ${
                    !isProPlan ? "text-gray-800" : "text-gray-500"
                  }`}
                >
                  Launch GCSE
                </span>
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-600 rounded-full peer-checked:bg-purple-600 after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full"></div>
                </label>
                <span
                  className={`text-sm ${
                    isProPlan ? "text-gray-800" : "text-gray-500"
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6 w-full">
              <div className="bg-gray-800 border border-purple-700 rounded-lg p-6 w-full md:w-1/2 lg:w-[70%]">
                ...
                <button className="w-full bg-purple-700 hover:bg-purple-800 text-white py-2 rounded-md mb-6">
                  Sign Up
                </button>
                      ...
                      >
                        ...
                        <td className="p-4 border-b border-gray-300 text-center">
                          <input
                            ...
                            onChange={(e) =>
                              handleCombinationSelection(e.target.value)
                            }
